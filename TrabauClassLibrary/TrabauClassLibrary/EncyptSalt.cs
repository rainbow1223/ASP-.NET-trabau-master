    ...
    public class EncyptSalt
    {
        ...
        public static string EncryptText(string input, string Key)
        {
            ...
            try
            {
                ...
                byte[] saltBytes = Encoding.UTF8.GetBytes(Key + "_SALT_DATA");
        ...
        public static string DecryptText(string input, string Key)
        {
            ...
            try
            {
                ...
                using (Aes myAes = Aes.Create())
                {
                    ...
                    string stringDecrypted = DecryptStringFromBytes_Aes(bytesToBeDecrypted, myAes.Key, myAes.IV);
                    str = stringDecrypted;
                }
            }
            catch (Exception ex)
